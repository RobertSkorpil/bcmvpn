FROM debian:buster
RUN apt update
RUN apt -y install procps sudo systemd dbus realmd dmidecode openssh-server ca-certificates c3270 openssl iptables
...
#RUN killall PanGPS; rm /var/run/PanGPS.pid
